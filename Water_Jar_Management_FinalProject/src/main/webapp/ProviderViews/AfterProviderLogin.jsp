					...
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								...
								<li><a href="/ProviderViews/LoginProvider.jsp">Provider</a></li>
								<li>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 offset-lg-2 text-center">
				<div class="section-title">	
					<h3><span class="orange-text">Provider</span> Functionalities</h3>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 text-center">
				<div class="single-product-item">
					<div class="product-image">
						<a href="/ProviderViews/AddProduct.jsp"><img src="assets/img/add product.jpg" alt=""></a>
					</div>
					<h3>Add Product</h3>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 text-center">
				<div class="single-product-item">
					<div class="product-image">
						<a href="/ProviderViews/AddSupplier.jsp"><img src="assets/img/manage supplier.jpg" alt=""></a>
					</div>   <!--  --> 
					<h3>Add Supplier</h3>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 text-center">
				<div class="single-product-item">
					<div class="product-image">
						<a href="http://localhost:3000/"><img src="assets/img/view product.jpg" alt=""></a>
					</div>
